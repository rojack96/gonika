...
func parseGenerationType(startIndex int, body []byte) (uint8, int) {
...
func parseOneByteIO(startIndex int, body []byte) (uint8, map[uint16]uint8, int) {
...
func parseTwoByteIO(startIndex int, body []byte) (uint8, map[uint16]uint16, int) {
...
func parseFourByteIO(startIndex int, body []byte) (uint8, map[uint16]uint32, int) {
...
func parseEightByteIO(startIndex int, body []byte) (uint8, map[uint16]uint64, int) {
