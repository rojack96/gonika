...
func ResponseDataMappingCodec12(responseData []byte) *models.ResponseMessage {
	...
	result = models.ResponseMessage{
		...
		Type:              responseData[10],
		ResponseSize:      [4]byte(responseData[11:15]),
